...
#define EDGE_P0_ANA NRF_SAADC_INPUT_AIN0
#define EDGE_P1  NRF_GPIO_PIN_MAP(0, 3)
#define EDGE_P1_ANA NRF_SAADC_INPUT_AIN1
#define EDGE_P2  NRF_GPIO_PIN_MAP(0, 4)
#define EDGE_P2_ANA NRF_SAADC_INPUT_AIN2
#define EDGE_P3  NRF_GPIO_PIN_MAP(0,31)
#define EDGE_P3_ANA NRF_SAADC_INPUT_AIN7
#define EDGE_P4  NRF_GPIO_PIN_MAP(0,28)
#define EDGE_P4_ANA NRF_SAADC_INPUT_AIN4
...
#define EDGE_P10_ANA NRF_SAADC_INPUT_AIN6
